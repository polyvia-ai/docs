...
<Update label="Polyvia-1.0 — API & SDKs" description="2026" tags={["API", "SDK", "MCP"]}>
  ## The developer release

  Everything you need to build multimodal document intelligence into your own
  agents and apps.
...
<Update label="Polyvia-1.1 — Platform" description="2026" tags={["Platform"]}>
...
<Note>
  **Soon after — Polyvia Agents:** build your own agent for automating processes
  ...
  expanded ingest types (CAD, geospatial, molecular). Follow along on the
