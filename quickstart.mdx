...
<Steps>
  ...
  <Step title="Create a key">
    Open **API** in the sidebar at [app.polyvia.ai](https://app.polyvia.ai/api-keys), then **Create API Key**. Copy it — it's shown only once. All
...
<Note>
  **Need help?** Email [senyao@polyvia.ai](mailto:senyao@polyvia.ai) or open
  [Polyvia Platform](https://app.polyvia.ai).
</Note>
