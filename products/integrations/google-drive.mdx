...
Google session lives in the Google sign-in popup itself. To use a different account, sign out at [accounts.google.com](https://accounts.google.com) and click Import again.
