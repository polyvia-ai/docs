...
<AccordionGroup>
  <Accordion title="PDF" icon="file-pdf">
    Reports, filings, contracts, research papers, scanned books. Polyvia extracts text, tables, charts, and figures — preserving page numbers and layout for citations.
