...
Open **Settings → Integrations** and click **Disconnect** on the Amazon S3 row. This clears the locally-stored credentials. Previously imported objects remain in Polyvia.
